  ...
  return (
    <footer className="bg-gray-800 text-gray-300 ">
      <div className="container mx-auto px-6 py-10 grid md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-amber-400">BookBorrow</h2>
        ...
        <div>
          ...
          <div className="flex gap-4 text-xl">
            <Link href="#"><FaFacebook className="hover:text-amber-400 transition" /></Link>
            <Link href="#"><FaInstagram className="hover:text-amber-400 transition" /></Link>
            <Link href="#"><FaGithub className="hover:text-amber-400 transition" /></Link>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mt-2 text-gray-400">Kaliganj, Bangladesh</p>
        </div>
